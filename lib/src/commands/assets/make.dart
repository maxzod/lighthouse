...
class AssetsMakeCommand extends Command {
  ...
  Future<void> run() async {
    /// load asset children
    final assetChildren = await loadDirectoryFiles('assets');

    /// for each child make a class
...
String findName(String path) => path.split('\\').last;
String findNameWithoutFormat(String path) {
  final name = findName(path).split('.').first;
  return name.camelCase;
}

String findFSTypeComment(String path) {
  final fName = findName(path);
